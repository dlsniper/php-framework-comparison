...
class jInstallerMessageProvider {
    ...
    protected $messages = array(
        'fr'=>array(
     'checker.title'=>'Vérification de votre serveur pour Jelix 1.4',
    ...
    'conclusion.error'      =>'Vous devez corriger l\'erreur pour faire fonctionner correctement une application Jelix 1.4.',
    'conclusion.errors'     =>'Vous devez corriger les erreurs pour faire fonctionner correctement une application Jelix 1.4.',
    'conclusion.warning'    =>'Une application Jelix 1.4 peut à priori fonctionner, mais il est préférable de corriger l\'avertissement pour être sûr.',
    'conclusion.warnings'   =>'Une application Jelix 1.4 peut à priori fonctionner, mais il est préférable de corriger les avertissements pour être sûr.',
    'conclusion.notice'     =>'Aucun problème pour installer une application pour Jelix  1.4 malgré la remarque.',
    'conclusion.notices'    =>'Aucun problème pour installer une application pour Jelix  1.4 malgré les remarques.',
    'conclusion.ok'         =>'Vous pouvez installer une application avec Jelix 1.4',
        ...
        'en'=>array(
  'checker.title'   =>'Check your configuration server for Jelix 1.4',
      ...
      'conclusion.error'    =>'You must fix the error in order to run an application correctly with Jelix 1.4.',
      'conclusion.errors'   =>'You must fix errors in order to run an application correctly with Jelix 1.4.',
      'conclusion.warning'  =>'Your application for Jelix 1.4 may run without problems, but it is recommanded to fix the warning.',
      'conclusion.warnings' =>'Your application for Jelix 1.4 may run without problems, but it is recommanded to fix warnings.',
      'conclusion.notice'   =>'You can install an application for Jelix 1.4, although there is a notice.',
      'conclusion.notices'  =>'You can install an application for Jelix 1.4, although there are notices.',
      'conclusion.ok'       =>'You can install an application for Jelix 1.4.',
